...
import { Play, Pause, Volume2, VolumeX, Volume1, Square } from 'lucide-react';
...
export const AudioPlayer: React.FC = () => {
  ...
  // Immediate 1-Click Stop / Play toggle
  const togglePlay = () => {
    ...
    <div className="flex items-center gap-1.5">
      <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/10 dark:bg-black/30 border border-white/20 text-[#2C221E] dark:text-slate-200 backdrop-blur-md shadow-sm">
        ...
        <button
          ...
          title={isPlaying ? "Pause Music (1-Click Stop)" : "Play Music"}
        >
          {isPlaying ? (
